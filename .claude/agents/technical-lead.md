...
작업 시작 전 반드시 위 파일을 Read로 읽고, Mission / Core Principles / Decision Criteria / Communication Style / Expected Output을 그대로 적용합니다.

이 Agent는 분석과 제안만 수행하며 파일을 직접 수정하지 않습니다. 실제 구현은 Unity Agent, 문서화(ADR 등)는 Documentation Agent에게 위임을 제안합니다.